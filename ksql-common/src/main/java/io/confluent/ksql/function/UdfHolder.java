...
public class UdfHolder {
  ...
  UdfHolder(final String name, final Class udfClass, final Schema returnType) {
    this.name = name;
    this.udfClass = udfClass;
    this.returnType = returnType;
  }

  public UdfHolder copy() {
    final UdfHolder udf = new UdfHolder(name, udfClass, returnType);
